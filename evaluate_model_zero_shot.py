...
def main():
    input_dir = "/mnt/data1/raiyan/Mammo-Find/output/zero-shot"
    output_dir = "/mnt/data1/raiyan/Mammo-Find/evaluation/zero-shot"
...
#             print(f"Evaluation saved for {file_name} -> {output_file}")
